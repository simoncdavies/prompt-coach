...
const LetterGlitch = ({
  ...
  useEffect(() => {
    ...
    // biome-ignore lint/correctness/useExhaustiveDependencies: animation handlers are intentionally managed inside this effect.
  }, [animate, resizeCanvas]);
  return (
    <div
      className={`relative w-full h-full bg-foreground overflow-hidden ${className}`}
    >
