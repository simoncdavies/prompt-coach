...
export function RecentRuns({ onSelect }: RecentRunsProps) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-semibold text-[#2D3A3A] uppercase tracking-wide">
        Recent Analyses
      </h3>
            ...
            <CardContent>
              ...
              <div className="flex justify-between items-center">
                <Badge variant="outline" className="text-[10px]">
                  {run.metadata.targetModel}
                </Badge>
                <span className="text-[10px] text-[#2BA84A] opacity-0 group-hover:opacity-100 transition-opacity font-medium">
                  Open result →
                </span>
              </div>
            </CardContent>
