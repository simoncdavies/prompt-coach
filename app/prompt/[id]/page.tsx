        ...
        {data && !loading && (
          ...
          >
            <div className="max-w-4xl mx-auto space-y-4">
              <h2 className="text-2xl font-bold text-[#040F0F]">
                Your Prompt Review
              </h2>
              <div className="p-6 rounded-xl bg-[#FCFFFC] border border-[#2D3A3A]/20 shadow-sm space-y-2">
                <p className="text-xs font-semibold text-[#2D3A3A] uppercase tracking-wider">
                  Original prompt
                </p>
                <p className="text-[#2D3A3A] font-mono text-sm whitespace-pre-wrap">
                  {data.prompt_original}
                </p>
              </div>
            </div>
